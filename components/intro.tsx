    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="/Bhishman_Desai.JPG"
              alt="Bhishman Desai portrait"
              width="192"
              height="192"
              quality="95"
              priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Bhishman.</span> I'm a{" "}
        <span className="font-bold">Full-Stack Software Engineer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        architecting, building and deploying <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">Solutions Architect</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://ca.linkedin.com/in/bhishman-desai"
          target="_blank"
        >
          <BsLinkedin />
        </a>
